...
/// An [IItemTexture] that renders a block texture.
public class BlockItemTexture implements IItemTexture {
    ...
    public BlockItemTexture(IIcon icon, ImmutableColor color) {
        this.icon = ignored -> icon;
        this.color = ignored -> color;
    }

    public BlockItemTexture(Supplier<IIcon> icon, Supplier<ImmutableColor> color) {
        this.icon = ignored -> icon.get();
        this.color = ignored -> color.get();
    }

    public BlockItemTexture(Function<ItemStack, IIcon> icon, Function<ItemStack, ImmutableColor> color) {
        this.icon = icon;
        this.color = color;
    }
