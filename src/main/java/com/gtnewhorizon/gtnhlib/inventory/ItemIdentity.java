...
/**
 * Packs item identity (id + metadata) into a single {@code long}. Id in high 32 bits, meta in low 32 bits: Meta is
 * zeroed for non-subtype/damageable items. NBT excluded.
 */
