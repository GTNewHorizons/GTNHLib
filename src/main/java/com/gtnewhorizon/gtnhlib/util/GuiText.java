 ...
 * Use this when a GUI draws hardcoded strings (like "+", "-1", "->", "/", etc.) that you want resource packs to recolor / rewrite
 * Keys are namespaced automatically with "gtnhlib." so you only pass the short key: "symbol.plus" -> looks up "gtnhlib.symbol.plus"
 * Client-side only
 */
...
public final class GuiText {
     ...
     * These are optional helpers to avoid typos and keep key names consistent
     * Example usage:
