 ...
 * you want resource packs to recolor / rewrite Keys are namespaced automatically with "gtnhlib." so you only pass the
 * short key: "symbol.plus" -> looks up "gtnhlib.symbol.plus" Client-side only
 */
...
public final class GuiText {
     ...
     * fallback is returned - optional debug logging may occur - optional crash may be triggered (dev only)
     */
    ...
    /*
     * Common key constants for GUI text These are optional helpers to avoid typos and keep key names consistent Example
     * usage: (GuiText.format(GuiText.Keys.ARROW_LEFT,"<")
     */
