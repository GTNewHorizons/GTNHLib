...
public final class NumberFormatConfig {
    ...
    @Config.Comment({ "Completely disables scientific notation, all numbers will render as e.g. 1,000." })
    @Config.DefaultBoolean(false)
    public static boolean globalDisableScientific = false;
    ...
    @Config.Ignore
    public static ScientificFormat SCIENTIFIC_FORMAT = ScientificFormat.SCIENTIFIC;
}
