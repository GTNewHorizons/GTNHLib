...
public class MixinEffectRenderer_FixParticleIcons {
    ...
    @ModifyExpressionValue(method = "addBlockDestroyEffects", at = @At(value = "NEW", target = "(Lnet/minecraft/world/World;DDDDDDLnet/minecraft/block/Block;I)Lnet/minecraft/client/particle/EntityDiggingFX;"))
    ...
    @ModifyExpressionValue(method = "addBlockHitEffects", at = @At(value = "NEW", target = "(Lnet/minecraft/world/World;DDDDDDLnet/minecraft/block/Block;I)Lnet/minecraft/client/particle/EntityDiggingFX;"))
