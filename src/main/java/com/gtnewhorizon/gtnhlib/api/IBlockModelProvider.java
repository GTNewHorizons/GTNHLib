 ...
 * JSON models. This effectively allows for overwriting {@link ModelISBRH#getModel} without needing a child class, which
 * avoids needing a new render ID (and associated mixins).
 */
