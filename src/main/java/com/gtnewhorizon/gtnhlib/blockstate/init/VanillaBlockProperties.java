...
class VanillaBlockProperties {
    ...
    static void initVanilla() {
        ...
        registerProperty(
            BlockQuartz.class,
            new AbstractAxisBlockProperty("axis") {
        ...
        registerProperty(Arrays.asList(Blocks.golden_rail, Blocks.detector_rail, Blocks.activator_rail), new RailModeProperty(false));
        ...
        registerProperty(Blocks.redstone_torch, BooleanBlockProperty.blocks("powered", Blocks.unlit_redstone_torch, Blocks.redstone_torch));
        registerProperty(Blocks.unlit_redstone_torch, BooleanBlockProperty.blocks("powered", Blocks.unlit_redstone_torch, Blocks.redstone_torch));
        ...
        class StandingSignRotationProperty implements FloatBlockProperty, MetaBlockProperty<Float>,
            ...
            public @NotNull Float transform(Float value, VectorTransform transform) {
                Vector3f v = new Vector3f(0, 0, 1)
                    .rotateAxis(value * (float) Math.PI * 2f / 360f, 0, 1, 0);
        ...
        registerProperty(BlockTrapDoor.class, DirectionBlockProperty.facing(0b1000, -1, -1, -1, -1, 0b1000, 0).setName("up"));

        registerProperty(BlockRedstoneLight.class, BooleanBlockProperty.blocks("powered", Blocks.redstone_lamp, Blocks.lit_redstone_lamp));
        ...
        registerProperty(
            Arrays.asList(Blocks.unpowered_comparator, Blocks.powered_comparator),
            IntegerBlockProperty.meta("mode", 0b100, 2)
