...
public class GlVertexAttribute {
     ...
     */
    public GlVertexAttribute(GlVertexAttributeFormat format, String name, int count, boolean normalized, int pointer,
            int stride, boolean intType) {
        this(format, format.size() * count, count, name, normalized, pointer, stride, intType);
    }

    protected GlVertexAttribute(GlVertexAttributeFormat format, int size, int count, String name, boolean normalized,
            int pointer, int stride, boolean intType) {
        this.format = format;
        this.size = size;
        this.count = count;
