...
public interface ChunkPrimitiveType {
     ...
     * buffer.
     *
     * The caller is responsible for providing a buffer of size given by
     * {@link ChunkPrimitiveType#getIndexBufferSize(int)}.
     * 
     ...
     */
    void generateSortedIndexBuffer(ByteBuffer indexBuffer, int numPrimitives,
            @Nullable TranslucentQuadAnalyzer.SortState chunkData, float x, float y, float z);
