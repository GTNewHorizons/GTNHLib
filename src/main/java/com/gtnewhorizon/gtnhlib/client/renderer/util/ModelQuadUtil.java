 ...
 *
 * Byte Index Integer Index Name Format Fields 0 ..11 0..2 Position 3 floats x, y, z 12..15 3 Color 4 unsigned bytes a,
 * r, g, b 16..23 4..5 Block Texture 2 floats u, v 24..27 6 Light Texture 2 shorts u, v 28..30 7 Normal 3 unsigned bytes
 * x, y, z 31 Padding 1 byte
 */
public class ModelQuadUtil {
    ...
    static {
        for (int i = 0; i < NORMALS.length; i++) {
            ...
            NORMALS[i] = NormI8.pack(dir.offsetX, dir.offsetY, dir.offsetZ);
        }
    }
    ...
    public static int getFacingNormal(ForgeDirection facing, int bakedNormal) {
        if (!hasNormal(bakedNormal)) return NORMALS[facing.ordinal()];
        return bakedNormal;
    }
