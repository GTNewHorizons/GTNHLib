...
public interface QuadBuilder {
    ...
    /**
     * Causes texture to appear with no rotation. Pass in bakeFlags parameter to {@link #spriteBake(IIcon, int)}.
     */
     ...
     * replaced. Pass in bakeFlags parameter to {@link #spriteBake(IIcon, int)}.
     *
     * <p>
     ...
     * both can be applied. Pass in bakeFlags parameter to {@link #spriteBake(IIcon, int)}.
     */
    int BAKE_FLIP_U = 8;
     ...
     * {@link #square(ForgeDirection, float, float, float, float, float)} is effectively zero - meaning the face is a
     * cull face.
     */
