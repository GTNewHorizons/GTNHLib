...
public class Model4Rot {
    ...
    public Model4Rot(ResourceLocation modelLoc) {
        ...
        this.modelIds = new Variant[] { new Variant(modelLoc, 0, 0, false), new Variant(modelLoc, 180, 0, false),
                new Variant(modelLoc, 90, 0, false), new Variant(modelLoc, 270, 0, false) };
