...
public class BlockTestAo extends Block {
    ...
    public static void register() {
        final var testBlock = new BlockTestAo();
        testBlock.setBlockName("model_test_ao");
        GameRegistry.registerBlock(testBlock, "model_test_ao");
