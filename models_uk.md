...
### Колишні відхилення
Посилання на текстури більше не вважаються прив’язаними до розташувань 1.7.10.
Замість цього вони обробляються з assets/namespace/textures, як у сучасних версіях.
Це також означає, що тепер ви можете використовувати будь-яку текстуру у своєму ISBRH,
і GTNHLib впровадить її в атлас блоків. Будь ласка, використовуйте цю можливість відповідально.
